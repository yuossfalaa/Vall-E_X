...
def split_text_into_sentences(text):
    if langid.classify(text)[0] == "en":
        ...
        pattern = r"[.!؟]"
        result = list(filter(None, re.split(pattern, text)))
        return result
    raise RuntimeError("It is impossible to reach here.")


long_text = "وقت الشرطة المكان، عقب انتهاء الوقت المحدد لهم بالمغادرة. وكان المهاجرون يسعون لى   الوصول إلى بريطانيا، " \
